...
* [Stopwatch](CupTaster/Helpers/Stopwatch.swift) - секундомер для того, чтобы понимать сколько времени прошло с момента добавления воды, слома кофейной корки, дегустации кофе. Запустить можно почти на всех экранах вкладки Cupping.
