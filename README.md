...
Содержание:
[Установка](#Установка)
[Суть в кратце](#Суть_в_кратце)
[Основные экраны (скриншоты приложения)](#Основные_экраны)
[Core Data (скриншот базы данных)](#Core_Data)
[Содержание папок и файлов](#Содержание_папок_и_файлов)
...
* [Stopwatch](CupTaster/Helpers/Stopwatch.swift) - секундомер для <blank> . Используется почти на всех экранах вкладки Cupping.
